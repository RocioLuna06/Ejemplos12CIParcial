...
namespace Ejemplos12CIParcial
{
    public partial class frmFactura : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'hospitalmedykalsystemDataSet.Factura' Puede moverla o quitarla según sea necesario.
            this.facturaTableAdapter.Fill(this.hospitalmedykalsystemDataSet.Factura);
